...
int main() {
    ...
    std::cout << "It's been a strange day indeed. you've fallen down a rabbit hole, happend across a strange tea party, and how many other absurd adventures.\n";
    std::cout << "But now, you are called to a trial of some sort, ushered in by a Gryphon.\n";
    std::cout << "The King and Queen of Hearts are seated on their throne when you arrive, with a great crowd assembled about them - all sort of little birds and beasts, as well as the whole pack of cards.\n";
    ...
    for (int i = 0; i < 3 && choice1 != 'A' && choice1 != 'B' && choice1 != 'C'; i++) {
        ...
        std::cout << "Enter C if you sit and wait for the trail to begin.\n";
        std::cin >> choice1;
    ...
    switch(choice1) {
        case 'A':
            ...
            std::cout << "'How stupid!' you say in aloud voice, but you are cut off.\n";
        ...
        case 'B':
            ...
            std::cout << "'SHE stole the tarts! Theif! OFF WITH HER HEAD!' the Queen is pointing at you. Her face is growing redder as her voice gets higher.\n";
    ...
    std::cout << "The Knave of Hearts, she made some tarts,\n";
    ...
    for (int i = 0; i < 3 && choice2 != 'A' && choice2 != 'B'; i++) {
        ...
        std::cout << "Enter B if you decide to wait until the trail is over.\n";
        std::cin >> choice2;
    ...
    std::cout << "You stay, much to the annoyance of the Doormouse who is getting squeezed sitting next to you.\n";
    ...
    std::cout << "You watch the White Rabbit fumble over the list. He reads at the top of his shrill voice:\n";
    std::cout << "ALICE!\n";
    std::cout << "\n";
    std::cout << "*      *      *\n";
    ...
    if (choice4 != 'A' && choice4 != 'B' && choice4 != 'C') {
        ...
        std::cout << "Here! You jump up in such a hurry that you knock over the jury box with edge of your skirt.\n";
    ...
    std::cout << "At this, the whole pack rises up into the air and files down on you.\n";
